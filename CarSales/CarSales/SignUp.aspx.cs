...
namespace CarSales
{
    public partial class SignUp : System.Web.UI.Page
    {
        ...
        protected void Btn_signUp_Click(object sender, EventArgs e)
        {
            ...
            {
                sendMail("Hello " + name.Text.ToString() + "\n Thank you for joining us. SellBay is available at your service and we would notify you as per your activity. Please click on the following link to complete the registration.\n\n https://localhost:44311/verifyUser.aspx");
